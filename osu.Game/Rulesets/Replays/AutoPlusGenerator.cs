...
{
    public abstract class AutoPlusGenerator
    {
        /// <summary>
        /// The default duration of a key press in milliseconds.
        /// </summary>
        public const double KEY_UP_DELAY = 0;
        ...
        protected AutoPlusGenerator(IBeatmap beatmap)
        {
            Beatmap = beatmap;
        }
    ...
    public abstract class AutoPlusGenerator<TFrame> : AutoPlusGenerator
